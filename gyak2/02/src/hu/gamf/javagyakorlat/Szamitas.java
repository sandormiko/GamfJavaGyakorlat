...
public class Szamitas {
    ...
    public String toString() {
        return "Szamitas{" + "szamitasId=" + szamitasId + ", nettoOsszeg=" + nettoOsszeg + ", adoErtek=" + adoErtek + ", afaErteke=" + afaErteke + ", bruttoErtek=" + bruttoErtek + ", letrehozasIdeje=" + letrehozasIdeje + ", szemelyId=" + szemelyId + '}';
    }
